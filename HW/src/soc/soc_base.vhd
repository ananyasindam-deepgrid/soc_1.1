...
----------------------------------------------------------------------------   
   ...
   -- dgrid control axi bus

   SIGNAL DGRID_CONTROL_awaddr:STD_LOGIC_VECTOR(31 downto 0);
   SIGNAL DGRID_CONTROL_awlen:STD_LOGIC_VECTOR(7 downto 0);
   SIGNAL DGRID_CONTROL_awsize:STD_LOGIC_VECTOR(2 downto 0);
   SIGNAL DGRID_CONTROL_awburst:STD_LOGIC_VECTOR(1 downto 0);
   SIGNAL DGRID_CONTROL_awvalid:STD_LOGIC;
   SIGNAL DGRID_CONTROL_awready:STD_LOGIC;
   SIGNAL DGRID_CONTROL_awid:STD_LOGIC_VECTOR(0 downto 0);
   SIGNAL DGRID_CONTROL_awlock:STD_LOGIC_VECTOR(0 downto 0);
   SIGNAL DGRID_CONTROL_awcache:STD_LOGIC_VECTOR(3 downto 0);
   SIGNAL DGRID_CONTROL_awprot:STD_LOGIC_VECTOR(2 downto 0);
   SIGNAL DGRID_CONTROL_awqos:STD_LOGIC_VECTOR(3 downto 0);
   SIGNAL DGRID_CONTROL_wdata:STD_LOGIC_VECTOR(31 downto 0);
   SIGNAL DGRID_CONTROL_wstrb:STD_LOGIC_VECTOR(3 downto 0);
   SIGNAL DGRID_CONTROL_wlast:STD_LOGIC;
   SIGNAL DGRID_CONTROL_wvalid:STD_LOGIC;
   SIGNAL DGRID_CONTROL_wready:STD_LOGIC;
   SIGNAL DGRID_CONTROL_bready:STD_LOGIC;
   SIGNAL DGRID_CONTROL_bresp:STD_LOGIC_VECTOR(1 downto 0);
   SIGNAL DGRID_CONTROL_bvalid:STD_LOGIC;
   SIGNAL DGRID_CONTROL_bid:STD_LOGIC_VECTOR(0 downto 0);
      
   SIGNAL DGRID_CONTROL_araddr:STD_LOGIC_VECTOR(31 downto 0);
   SIGNAL DGRID_CONTROL_arlen:STD_LOGIC_VECTOR(7 downto 0);
   SIGNAL DGRID_CONTROL_arsize:STD_LOGIC_VECTOR(2 downto 0);
   SIGNAL DGRID_CONTROL_arburst:STD_LOGIC_VECTOR(1 downto 0);
   SIGNAL DGRID_CONTROL_arvalid:STD_LOGIC;
   SIGNAL DGRID_CONTROL_arready:STD_LOGIC;
   SIGNAL DGRID_CONTROL_arid:STD_LOGIC_VECTOR(0 downto 0);
   SIGNAL DGRID_CONTROL_arlock:STD_LOGIC_VECTOR(0 downto 0);
   SIGNAL DGRID_CONTROL_arcache:STD_LOGIC_VECTOR(3 downto 0);
   SIGNAL DGRID_CONTROL_arprot:STD_LOGIC_VECTOR(2 downto 0);
   SIGNAL DGRID_CONTROL_arqos:STD_LOGIC_VECTOR(3 downto 0);
   SIGNAL DGRID_CONTROL_rready:STD_LOGIC;
   SIGNAL DGRID_CONTROL_rdata:STD_LOGIC_VECTOR(31 downto 0);
   SIGNAL DGRID_CONTROL_rresp:STD_LOGIC_VECTOR(1 downto 0);
   SIGNAL DGRID_CONTROL_rlast:STD_LOGIC;
   SIGNAL DGRID_CONTROL_rvalid:STD_LOGIC;
   SIGNAL DGRID_CONTROL_rid:STD_LOGIC_VECTOR(0 downto 0);
   ...
   SIGNAL DGRID_DATA_araddr:STD_LOGIC_VECTOR(31 downto 0);
   SIGNAL DGRID_DATA_arburst:STD_LOGIC_VECTOR(1 downto 0);
   SIGNAL DGRID_DATA_arcache:STD_LOGIC_VECTOR(3 downto 0);
   SIGNAL DGRID_DATA_arid:STD_LOGIC_VECTOR(0 downto 0);
   SIGNAL DGRID_DATA_arlen:STD_LOGIC_VECTOR(7 downto 0);
   SIGNAL DGRID_DATA_arlock:STD_LOGIC_VECTOR(0 downto 0);
   SIGNAL DGRID_DATA_arprot:STD_LOGIC_VECTOR(2 downto 0);
   SIGNAL DGRID_DATA_arqos:STD_LOGIC_VECTOR(3 downto 0);
   SIGNAL DGRID_DATA_arready:STD_LOGIC;
   SIGNAL DGRID_DATA_arsize:STD_LOGIC_VECTOR(2 downto 0);
   SIGNAL DGRID_DATA_arvalid:STD_LOGIC;
   SIGNAL DGRID_DATA_awaddr:STD_LOGIC_VECTOR(31 downto 0);
   SIGNAL DGRID_DATA_awburst:STD_LOGIC_VECTOR(1 downto 0);
   SIGNAL DGRID_DATA_awcache:STD_LOGIC_VECTOR(3 downto 0);
   SIGNAL DGRID_DATA_awid:STD_LOGIC_VECTOR(0 downto 0);
   SIGNAL DGRID_DATA_awlen:STD_LOGIC_VECTOR(7 downto 0);
   SIGNAL DGRID_DATA_awlock:STD_LOGIC_VECTOR(0 downto 0);
   SIGNAL DGRID_DATA_awprot:STD_LOGIC_VECTOR(2 downto 0);
   SIGNAL DGRID_DATA_awqos:STD_LOGIC_VECTOR(3 downto 0);
   SIGNAL DGRID_DATA_awready:STD_LOGIC;
   SIGNAL DGRID_DATA_awsize:STD_LOGIC_VECTOR(2 downto 0);
   SIGNAL DGRID_DATA_awvalid:STD_LOGIC;
   SIGNAL DGRID_DATA_bid:STD_LOGIC_VECTOR(0 downto 0);
   SIGNAL DGRID_DATA_bready:STD_LOGIC;
   SIGNAL DGRID_DATA_bresp:STD_LOGIC_VECTOR(1 downto 0);
   SIGNAL DGRID_DATA_bvalid:STD_LOGIC;
   SIGNAL DGRID_DATA_rdata:STD_LOGIC_VECTOR(63 downto 0);
   SIGNAL DGRID_DATA_rid:STD_LOGIC_VECTOR(0 downto 0);
   SIGNAL DGRID_DATA_rlast:STD_LOGIC;
   SIGNAL DGRID_DATA_rready:STD_LOGIC;
   SIGNAL DGRID_DATA_rresp:STD_LOGIC_VECTOR(1 downto 0);
   SIGNAL DGRID_DATA_rvalid:STD_LOGIC;
   SIGNAL DGRID_DATA_wdata:STD_LOGIC_VECTOR(63 downto 0);
   SIGNAL DGRID_DATA_wlast:STD_LOGIC;
   SIGNAL DGRID_DATA_wready:STD_LOGIC;
   SIGNAL DGRID_DATA_wstrb:STD_LOGIC_VECTOR(7 downto 0);
   SIGNAL DGRID_DATA_wvalid:STD_LOGIC;
...
begin
   ...
   DGRID_CONTROL_rlast <= '1';

   DGRID_CONTROL_rid <= (others=>'0');
   
   DGRID_CONTROL_bid <= (others=>'0');

   -- -----------------------------
   -- CPU. RISCV based on DgsRiscv
   -- ------------------------------
...
axi_split_dbus_i : axi_split
   ...
   (
      ...
      aximaster2_araddr_out=>DGRID_CONTROL_araddr,
      aximaster2_arlen_out=>DGRID_CONTROL_arlen,
      aximaster2_arvalid_out=>DGRID_CONTROL_arvalid,
      aximaster2_arid_out=>DGRID_CONTROL_arid,
      aximaster2_arlock_out=>DGRID_CONTROL_arlock,
      aximaster2_arcache_out=>DGRID_CONTROL_arcache,
      aximaster2_arprot_out=>DGRID_CONTROL_arprot,
      aximaster2_arqos_out=>DGRID_CONTROL_arqos,
      aximaster2_rid_in=>DGRID_CONTROL_rid,
      aximaster2_rvalid_in=>DGRID_CONTROL_rvalid,
      aximaster2_rlast_in=>DGRID_CONTROL_rlast,
      aximaster2_rdata_in=>DGRID_CONTROL_rdata,
      aximaster2_rresp_in=>DGRID_CONTROL_rresp,
      aximaster2_arready_in=>DGRID_CONTROL_arready,
      aximaster2_rready_out=>DGRID_CONTROL_rready,
      aximaster2_arburst_out=>DGRID_CONTROL_arburst,
      aximaster2_arsize_out=>DGRID_CONTROL_arsize,

      aximaster2_awaddr_out=>DGRID_CONTROL_awaddr,
      aximaster2_awlen_out=>DGRID_CONTROL_awlen,
      aximaster2_awvalid_out=>DGRID_CONTROL_awvalid,
      aximaster2_wvalid_out=>DGRID_CONTROL_wvalid,
      aximaster2_wdata_out=>DGRID_CONTROL_wdata,
      aximaster2_wlast_out=>DGRID_CONTROL_wlast,
      aximaster2_wstrb_out=>DGRID_CONTROL_wstrb,
      aximaster2_awready_in=>DGRID_CONTROL_awready,
      aximaster2_wready_in=>DGRID_CONTROL_wready,
      aximaster2_bresp_in=>DGRID_CONTROL_bresp,
      aximaster2_bid_in=>DGRID_CONTROL_bid,
      aximaster2_bvalid_in=>DGRID_CONTROL_bvalid,
      aximaster2_awburst_out=>DGRID_CONTROL_awburst,
      aximaster2_awcache_out=>DGRID_CONTROL_awcache,
      aximaster2_awid_out=>DGRID_CONTROL_awid,
      aximaster2_awlock_out=>DGRID_CONTROL_awlock,
      aximaster2_awprot_out=>DGRID_CONTROL_awprot,
      aximaster2_awqos_out=>DGRID_CONTROL_awqos,
      aximaster2_awsize_out=>DGRID_CONTROL_awsize,
      aximaster2_bready_out=>DGRID_CONTROL_bready,
...
axi_merge_inst : axi_merge 
   ...
   PORT MAP (
      ...
      axislavew_araddr_in=>DGRID_DATA_araddr,
      axislavew_arlen_in=>DGRID_DATA_arlen,
      axislavew_arvalid_in=>DGRID_DATA_arvalid, 
      axislavew_arid_in=>DGRID_DATA_arid,
      axislavew_arlock_in=>DGRID_DATA_arlock,
      axislavew_arcache_in=>DGRID_DATA_arcache,
      axislavew_arprot_in=>DGRID_DATA_arprot,
      axislavew_arqos_in=>DGRID_DATA_arqos,
      axislavew_rid_out=>DGRID_DATA_rid,
      axislavew_rvalid_out=>DGRID_DATA_rvalid,
      axislavew_rlast_out=>DGRID_DATA_rlast,
      axislavew_rdata_out=>DGRID_DATA_rdata,
      axislavew_rresp_out=>DGRID_DATA_rresp,
      axislavew_arready_out=>DGRID_DATA_arready,
      axislavew_rready_in=>DGRID_DATA_rready,
      axislavew_arburst_in=>DGRID_DATA_arburst,
      axislavew_arsize_in=>DGRID_DATA_arsize,
            
      axislavew_awaddr_in=>DGRID_DATA_awaddr,
      axislavew_awlen_in=>DGRID_DATA_awlen,
      axislavew_awvalid_in=>DGRID_DATA_awvalid,
      axislavew_wvalid_in=>DGRID_DATA_wvalid,
      axislavew_wdata_in=>DGRID_DATA_wdata,
      axislavew_wlast_in=>DGRID_DATA_wlast,
      axislavew_wstrb_in=>DGRID_DATA_wstrb,
      axislavew_awready_out=>DGRID_DATA_awready,
      axislavew_wready_out=>DGRID_DATA_wready,
      axislavew_bresp_out=>DGRID_DATA_bresp,
      axislavew_bid_out=>DGRID_DATA_bid,
      axislavew_bvalid_out=>DGRID_DATA_bvalid,
      axislavew_awburst_in=>DGRID_DATA_awburst,
      axislavew_awcache_in=>DGRID_DATA_awcache,
      axislavew_awid_in=>DGRID_DATA_awid,
      axislavew_awlock_in=>DGRID_DATA_awlock,
      axislavew_awprot_in=>DGRID_DATA_awprot,
      axislavew_awqos_in=>DGRID_DATA_awqos,
      axislavew_awsize_in=>DGRID_DATA_awsize,
      axislavew_bready_in=>DGRID_DATA_bready,
...
axi_stream_read_inst : axi_stream_read 
   ...
   DGRID_DATA_arlen(DGRID_DATA_arlen'length-1 downto arlen'length) <= (others=>'0');
   DGRID_DATA_arlen(arlen'length-1 downto 0) <= std_logic_vector(arlen);
   
   DGRID_DATA_awlen(DGRID_DATA_awlen'length-1 downto awlen'length) <= (others=>'0');
   DGRID_DATA_awlen(awlen'length-1 downto 0) <= std_logic_vector(awlen);
   ...
   dgrid_inst : dgrid 
      ...
      PORT MAP ( 
         ...
         -- clk_main is the main clock for dgrid and riscv
         ...
         axi_araddr_out=>DGRID_DATA_araddr,
         axi_arlen_out=>arlen,
         axi_arvalid_out=>DGRID_DATA_arvalid,
         axi_rvalid_in=>DGRID_DATA_rvalid,
         axi_rlast_in=>DGRID_DATA_rlast,
         axi_rdata_in=>DGRID_DATA_rdata,
         axi_arready_in=>DGRID_DATA_arready,
         axi_rready_out=>DGRID_DATA_rready,    
         axi_arburst_out=>DGRID_DATA_arburst,
         axi_arcache_out=>DGRID_DATA_arcache, -- Not used. Can be ignored
         axi_arid_out=>DGRID_DATA_arid,       -- Not used. Can be ignored
         axi_arlock_out=>DGRID_DATA_arlock,   -- Not used. Can be ignored
         axi_arprot_out=>DGRID_DATA_arprot,   -- Not used. Can be ignored
         axi_arqos_out=>DGRID_DATA_arqos,     -- Not used. Can be ignored
         axi_arsize_out=>DGRID_DATA_arsize,

         -- Write bus to DDR memory
         -- All tensor memory transfer from internal memory to DDR memory
         -- are via this bus
            
         axi_awaddr_out=>DGRID_DATA_awaddr,
         axi_awlen_out=>awlen,
         axi_awvalid_out=>DGRID_DATA_awvalid,
         axi_waddr_out=>open,
         axi_wvalid_out=>DGRID_DATA_wvalid,
         axi_wlast_out=>DGRID_DATA_wlast,
         axi_wdata_out=>DGRID_DATA_wdata,
         axi_wbe_out=>DGRID_DATA_wstrb,
         axi_awready_in=>DGRID_DATA_awready,
         axi_wready_in=>DGRID_DATA_wready,
         axi_bresp_in=>DGRID_DATA_bvalid,       
         axi_awburst_out=>DGRID_DATA_awburst,
         axi_awcache_out=>DGRID_DATA_awcache, -- Not used. Can be ignored
         axi_awid_out=>DGRID_DATA_awid,       -- Not used. Can be ignored
         axi_awlock_out=>DGRID_DATA_awlock,   -- Not used. Can be ignored
         axi_awprot_out=>DGRID_DATA_awprot,   -- Not used. Can be ignored
         axi_awqos_out=>DGRID_DATA_awqos,     -- Not used. Can be ignored
         axi_awsize_out=>DGRID_DATA_awsize,
         axi_bready_out=>DGRID_DATA_bready,

         -- RISCV is communicating with dgrid via the bus below
         -- Tensor instructions are pushed from RISCV to dgrid's tensor
         -- processor via this bus.

         axilite_araddr_in=>DGRID_CONTROL_araddr(io_depth_c-1 downto 0),
         axilite_arvalid_in=>DGRID_CONTROL_arvalid,
         axilite_arready_out=>DGRID_CONTROL_arready,
         axilite_rvalid_out=>DGRID_CONTROL_rvalid,
         axilite_rlast_out=>open,
         axilite_rdata_out=>DGRID_CONTROL_rdata,
         axilite_rready_in=>DGRID_CONTROL_rready,
         axilite_rresp_out=>DGRID_CONTROL_rresp,
         axilite_awaddr_in=>DGRID_CONTROL_awaddr(io_depth_c-1 downto 0),
         axilite_awvalid_in=>DGRID_CONTROL_awvalid,
         axilite_wvalid_in=>DGRID_CONTROL_wvalid,
         axilite_wdata_in=>DGRID_CONTROL_wdata,
         axilite_awready_out=>DGRID_CONTROL_awready,
         axilite_wready_out=>DGRID_CONTROL_wready,
         axilite_bvalid_out=>DGRID_CONTROL_bvalid,
         axilite_bready_in=>DGRID_CONTROL_bready,
         axilite_bresp_out=>DGRID_CONTROL_bresp,
...
-----------
-- UART1 for CAN bridge (WS-TTL-CAN module)
-- 256-entry deep FIFOs (FIFO_DEPTH=8 means 2^8=256 entries)
-----------
...
UART1_INST: entity work.UART
   generic map(
      ...
      APB_REG_READ=>84,
      APB_REG_WRITE=>88,
      APB_REG_READ_AVAIL=>92,
      APB_REG_WRITE_AVAIL=>96,
      FIFO_DEPTH_G=>8
      )
   port map(
      clock_in=>clk_main,
      reset_in=>'1',
      uart_rx_in=>UART1_RXD,
      uart_tx_out=>UART1_TXD,
      apb_paddr=>APB_PADDR,
      apb_penable=>APB_PENABLE,
      apb_pready=>APB_PREADY,
      apb_pwrite=>APB_PWRITE,
