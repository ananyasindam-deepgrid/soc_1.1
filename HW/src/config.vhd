------------------------------------------------------
-- This file contains tunable parameters for dgrid
------------------------------------------------------
...
-- dgrid accesses external memory via AXI bus protocol
-- dgrid supports 32-bit, 64-bit or 128-bit AXI bus width for 
