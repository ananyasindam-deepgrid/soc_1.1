create_project dgrid . -part xc7a100tcsg324-1 -force

read_verilog main.v
read_verilog ../../riscv/xilinx_jtag/riscv.v
read_vhdl ../../src/config.vhd
read_vhdl ../../src/dgrid_pkg.vhd
...
generate_target all [get_files dgrid.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci]
...
generate_target all [get_files dgrid.srcs/sources_1/ip/float_addsub/float_addsub.xci]
...
generate_target all [get_files dgrid.srcs/sources_1/ip/float_mul/float_mul.xci]

create_ip -name mig_7series -vendor xilinx.com -library ip -version 4.2 -module_name mig_7series_0

if {[string equal $argv linux]}  {
  exec cp mig.prj dgrid.srcs/sources_1/ip/mig_7series_0/mig.prj
} else {
  exec cmd /c copy mig.prj dgrid.srcs\\sources_1\\ip\\mig_7series_0\\mig.prj
}
set_property -dict [list CONFIG.XML_INPUT_FILE {mig.prj}] [get_ips mig_7series_0]

generate_target {instantiation_template} [get_files dgrid.srcs/sources_1/ip/mig_7series_0/mig_7series_0.xci]
generate_target all [get_files dgrid.srcs/sources_1/ip/mig_7series_0/mig_7series_0.xci]
