...
## UART1 for CAN bridge (WS-TTL-CAN module) - Pmod JB pins 9,10
set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports UART1_TXD]
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports UART1_RXD]
...
set_false_path -from [filter [all_fanout -from [get_ports clka]] {IS_LEAF}] -through [get_pins -of_objects
