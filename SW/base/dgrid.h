...
#define MEM_MAP  0x80000000 // dgrid address as mapped on AXI bus.
...
// Macro to access dgrid registers

#define DGRIDM_GREG(reg2,reg,vm)  (((volatile uint32_t *)MEM_MAP)[((reg2) << 5)+reg])

// dgrid register definitions
