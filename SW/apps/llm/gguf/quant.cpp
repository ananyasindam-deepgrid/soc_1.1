...
int main(int argc,char *argv[])
{
    ...
    if(argc != 5) {
        printf("Error: Usage quant [SIM|DGRID] [Q4|Q8] <gguf file> <zuf file>\r\n");
        return -1;
    }
    ...
    else if(strcmp(argv[1],"DGRID")==0) {
        printf("Quantize for dgrid \r\n");
        forSim = false;
    }
    else
    {
        printf("Error: Usage quant [SIM|DGRID] <gguf file> <zuf file>\r\n");
        return -1;
    }
    ...
    gguf.Open(argv[3]);
    if(gguf.SaveAsZUF(argv[4],forSim,quant) != DgridStatusOk)
