...
DgridStatus TfliteNn::PopulateConvolutionQuantizationParams(
...
DgridStatus TfliteNn::GetQuantizedConvolutionMultipler(const TfliteNnTensorDef* input,
...
DgridStatus TfliteNn::CalculateActivationRangeQuantized(NeuralNetActivation activation,
                                               TfliteNnTensorDef* output,
                                               int32_t* act_min,
                                               int32_t* act_max) {
  int32_t qmin = 0;
