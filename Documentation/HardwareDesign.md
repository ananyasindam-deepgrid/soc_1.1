...
![hw_dgrid](images/hw_dgrid.png)

### Interfaces:

- axilite_* : AXILite bus for RISCV to push tensor instructions to dgrid

- axi_* : AXI bus for dgrid to initiate DMA memory transfer to/from external memory
...
all activities within dgrid including memory transfer and launching execution on
the VLIW processor array.

### Functions:

This is the top-level component of dgrid.
...
This component is the main tensor processor of dgrid. It performs the following functions:
...
## dgrid.core.pcore.register_bank
...
tensor processor's threads. This is an important concept for dgrid since it allows
...
This is an important concept since with dgrid, data operations are decoupled
...
## dgrid.core.pcore.instr_decoder2
...
branching operation. dgrid currently does not support yet thread branching/divergence as commonly implemented in GPU, 
