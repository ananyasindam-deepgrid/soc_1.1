...
## 1. Prerequisites
To proceed with this document. Please familiar yourself with the software and hardware architecture of dgrid

[dgrid Hardware Architecture](https://github.com/dgrid/dgrid/blob/master/Documentation/HardwareArchitecture.md)

[dgrid Software Architecture](https://github.com/dgrid/dgrid/blob/master/Documentation/SoftwareArchitecture.md)
...
Below is an example of global variables from [conv.p](https://github.com/dgrid/dgrid/blob/master/software/target/apps/nn/kernels/conv.p)
```
...
[Example of a pcore program implementing convolution operator](https://github.com/dgrid/dgrid/blob/master/software/target/apps/nn/kernels/conv.p)

[Example of a pcore program implementing Canny edge detection](https://github.com/dgrid/dgrid/blob/master/software/target/apps/canny/kernels/canny.p)

[Example of a pcore program implementing image resize](https://github.com/dgrid/dgrid/blob/master/software/target/apps/resize/kernels/resize.p)
