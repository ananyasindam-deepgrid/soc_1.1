...
```
cd <dgrid installation folder>/HW/examples/GHRD
set argv linux # For Linux Only
source create_project.tcl
```

A project file dgrid.xpr should be created after the completion of the execution of create_project.tcl.


# Build and flash procedure. 

Open Vivado project file dgrid/HW/examples/GHRD/dgrid.xpr
...
Then program the board as shown below. The image to be flashed is dgrid/HW/examples/GHRD/dgrid.runs/impl_1/main.bin
...
You can convert dgrid rtl to verilog using ghdl
