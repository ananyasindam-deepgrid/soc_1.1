...
dgrid domain are applications that can be expressed as a sequential steps of tensor
...
dgrid's DSL is composed of 2 elements: 
...
provided with dgrid that converts these special extension to tensor instructions before
...
# Compare dgrid DSL with traditional programming
...
But with dgrid, data are loaded from external memory into internal memory in a streaming fashion with 
